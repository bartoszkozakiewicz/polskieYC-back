...
class ResearchPaper(BaseSchema):
    ...
    summary: Optional[str] = Field(None, title="Summary of the research paper generated by LLM")
    tags: Optional[list[str]] = Field(None, title="Tags of the research paper")
    published_date: Optional[str] = Field(None, title="Published date of the research paper")
    url: Optional[str] = Field(None, title="URL of the research paper")


class Scientist(BaseSchema):
    name: str = Field(..., title="Name of the scientist")
    email: str = Field(..., title="Email of the scientist")
    affiliation: str = Field(..., title="Affiliation of the scientist")
    summary: Optional[str] = Field(None, title="Summary of the scientist generated by LLM (aggregated from papers)")
    ...
    researchgate: Optional[str] = Field(None, title="ResearchGate profile of the scientist")
